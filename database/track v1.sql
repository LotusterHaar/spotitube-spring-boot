...
INSERT INTO `track` (`id`,`title`,`performer`,`duration`,`playcount`,`offlineAvailable`) VALUES (3,'Tenerife Sea','Ed Sheeran',241,239,0);
INSERT INTO `track` (`id`,`title`,`performer`,`duration`,`playcount`,`offlineAvailable`) VALUES (4,'The A Team','Ed Sheeran',258,247,1);
INSERT INTO `track` (`id`,`title`,`performer`,`duration`,`playcount`,`offlineAvailable`) VALUES (5,'Girls Like You ft. Cardi B','Maroon 5',270,167,0);
